...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("function output", "averageLessThanMedian: ${averageLessThanMedian(numbers)}")


        val context = this
        val collection = listOf(1, 2, 3, 4, 5)
        val view = getView(2, null, collection, context)
        Log.d("function output", "getView: ${view.toString()}")
